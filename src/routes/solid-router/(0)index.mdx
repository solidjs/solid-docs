...
version: "1.0"
description: >-
  New-Naration Router is the universal routing solution for Solid applications,
...
New-Naration Router is the universal router for Solid which works for rendering on the client or the server.
