...
With SolidStart being a Solid meta-framework, we recommend knowing Solid prior to digging into these docs (or at least [taking the Solid tutorial](https://www.solidjs.com/tutorial)).
