...
You can call this function with no arguments to get the current value of the signal:
...
When a signal is called within a [tracking scope](/concepts/intro-to-reactivity#tracking), the signal adds the dependency (what is tracking the signal) to a list of subscribers.
