...
- [Debugging reactivity](/guides/debugging-reactivity): when a test sees the old DOM, the reason is usually a pending flush; that page explains `flush()` and where it does not belong.
