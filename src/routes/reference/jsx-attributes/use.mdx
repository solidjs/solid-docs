...
<Callout type="caution" title="Custom components">
This directive does not currently work on custom components. [details here](https://github.com/solidjs/solid/discussions/722)
</Callout>
