...
We create a signal using Solid's `createSignal` function. This returns the getter and and setter as a _two-element array_. We typically use _array destructuring_ to assign the getter and setter into variables with names of our choosing.
