...
* [Memos](/concepts/derived-values/memos) resemble [effects](/concepts/effects) but are distinct in that they *return* a signal and optimize computations through caching. 
