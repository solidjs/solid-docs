...
version: '2.0'
description: >-
  Handle multiple exclusive conditions in Solid with Switch and Match. Clean
...
Match also supports function children. When a function child is provided, it receives the `when` value as an **accessor** — the matched value is narrowed and can be called reactively:
