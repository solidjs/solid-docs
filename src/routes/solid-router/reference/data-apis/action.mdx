...
By returning a response with solid-router's `json` or `reload` helpers you can pass a key / keys to the revalidate prop as the second argument of the json response helper.
