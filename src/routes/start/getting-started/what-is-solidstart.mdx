...
<Aside title="Beware of dragons" type="warning">
    We are very excited about SolidStart, but it is in alpha. There will very likely be **bugs and missing documentation**. Come at it with a growth attitude, have fun, and don't use it yet for anything critical.
