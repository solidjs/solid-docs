...
import {
  FrameworkAside,
  Aside,
} from "~/components/configurable/FrameworkAside";
...
Let's build our first component. This component will display `Hello World!` inside a `<div>` element. To do this, we need to create a file called

<IfConfig check="codeFormat" forValue="jsx" fallback="HelloWorld.tsx">
  "HelloWorld.jsx"
</IfConfig>
