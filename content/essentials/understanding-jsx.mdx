...
## How Solid uses JSX
Solid was designed to align closely with HTML standards. It offers a distinct advantage: copy/paste solutions from resources like Stack Overflow, and direct usage of templates from design tools.
