...
With [`start`](/reference/vite-plugin-solid/start), `ssr: true` selects turnkey SSR instead of turnkey client mode.
...
- Turnkey client mode keeps application code non-hydratable.
