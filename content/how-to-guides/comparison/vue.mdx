...
A lot of times developers find themselves using lists more times than not. In the case where you would like to make use of lists or arrays within your app, some frontend frameworks offer a way for you to do that fairly easily. Let's take a look at how **Vue** and **Solid** make that possible.
