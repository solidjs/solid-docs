...
Derived signals are functions that rely on one or more [signals](/solid-js/concepts/signals) to produce a value.
...
While you can create derived values in this manner, Solid created the [`createMemo`](/solid-js/reference/basic-reactivity/create-memo) primitive.
Learn more about [memos](/solid-js/concepts/derived-values/memos).