...
Solid Router provides a `Navigate` component that works similarly to [`<A>`](/reference/solid-router/components/a), but it will _immediately_ navigate to the provided path as soon as the component is rendered.
