...
The Router 2 package at the source revision for this guide requires `solid-js` and `@solidjs/web` versions from `2.0.0-beta.32` up to, but not including, `2.0.0-experimental.0`.
...
This lookup is pinned to `solidjs/solid-router` source revision `c2fddb08ac1ab29bedc7c264e632a8b14d8af0dd`, `src/data/query.ts`.
...
The age gate is pinned to `solidjs/solid-router` source revision `3daa4d071df288280eb0de996039cf591d8173f8`, `src/data/query.ts`.
...
This behavior is pinned to `solidjs/solid-router` source revision `bae09cc537eabf1b4b48b085885404a974285cce`, `src/fs.ts`.
