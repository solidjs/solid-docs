...
However, using `cache` directly in [`createResource`](/solid-js/reference/basic-reactivity/create-resource) will not work since the fetcher is not reactive and will not invalidate properly.
