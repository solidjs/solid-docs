...
4. [Navigation](/routing/solid-router/navigation): `paths`, `useNavigate`, location and search parameters, active links, and navigation guards.
5. [Data](/routing/solid-router/data): preloads, `query`, `action`, optimistic updates, and revalidation.
6. [Server rendering](/routing/solid-router/server-rendering): what changes when the app renders on the server or uses server functions.
