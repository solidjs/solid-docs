...
- [`renderToString`](/solid-js/reference/rendering/render-to-string) - "sync"
- [`renderToStringAsync`](/solid-js/reference/rendering/render-to-string-async) - "async"
- [`renderToStream`](/solid-js/reference/rendering/render-to-stream) - "stream"
