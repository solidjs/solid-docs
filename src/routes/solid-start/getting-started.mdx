...
The easiest way to get started with Solid is to use the SolidStart starter. SolidStart starter is a collection of templates that can be used to quickly bootstrap a new Solid application. 
