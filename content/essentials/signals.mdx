...
The explicit use of `createMemo` was more for illustrative purposes, showcasing its ability to make values reactive so components stay responsive to changes in state.
</Aside>