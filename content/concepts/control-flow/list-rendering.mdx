...
[Conditional rendering](/essentials/conditional-rendering) can also be used to show how, or if, certain elements are rendered based on conditions related to the `item` or `index`:
