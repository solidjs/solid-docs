...
**Note:** Tracking is the process of monitoring changes to signals.
...
[Synchronous](https://developer.mozilla.org/en-US/docs/Glossary/Synchronous) reactivity is when a system responds to changes in a direct and linear fashion.
...
**Note:** When using asynchronous reactivity, it is important to ensure that the system is able to handle the delay in updates.
