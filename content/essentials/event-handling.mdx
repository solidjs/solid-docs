...
Supported events such as `click`, `mouseover`, and `keydown` are just a few examples that aare optimized in this way. To view the full list see the [reference section](#delegated-events).
