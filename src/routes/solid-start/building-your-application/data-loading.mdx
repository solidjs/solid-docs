...
`createResource` integrates with [`Suspense`](/reference/api/suspense) and [`ErrorBoundary`](/reference/api/error-boundary) to help manage lifecycle and error states.
