...
Please note that `useBeforeLeave` can not be used to prevent single page navigations originating from the browser back/forward buttons being clicked (`popstate` event being fired).
