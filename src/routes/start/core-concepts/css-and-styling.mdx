...
Vite provides a simple way to manage CSS for a complex web app by allowing users to import CSS using ESM syntax anywhere in the component tree. One possible architecture is to write CSS in a file accompanying your component file.
...
The easiest mitigation for this pitfall is to utilize the power of SCSS/Sass. SCSS adds many zero cost CSS abstractions. Vite has first class support for pre-processors, so to use SCSS files, simply run:
...
- link to vite/scss, can use tailwind etc
