...
<div id="yarn">```bash frame="none" yarn create solid ```</div>

<div id="pnpm">```bash frame="none" pnpm create solid ```</div>

<div id="bun">```bash frame="none" bun create solid ```</div>
...
<div id="pnpm">```bash frame="none" pnpm i ```</div>
...
<div id="bun">```bash frame="none" bun dev ```</div>
