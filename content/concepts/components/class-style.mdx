...
In scenarios where you may want to conditionally set classes, Solid offers the built-in [`classList`](https://developer.mozilla.org/en-US/docs/Web/API/Element/classList) JSX attribute. 
...
If both are reactive, unexpected behaviors can occur: when the `class` value changes, Solid will set the entire `class` attribute, meaning any toggles in `classList` will be overwritten.
<br />
...
To dive deeper into how to style your Solid components, see our [detailed guide](guides/styling-your-components).
