...
- **Buildpack:** Simple Node.js deployment (`"start": "vinxi start"`).
...
![create-service-name](https://assets.northflank.com/Screenshot_2025_12_01_at_12_23_18_5947c7fdae.png)

**Select Build Option:** 

Choose Dockerfile/Buildpack for deployment.

![create-service-build](https://assets.northflank.com/Screenshot_2025_12_01_at_12_43_52_ebc40592e8.png)
...
![create-service-compute.png](https://assets.northflank.com/Screenshot_2025_12_01_at_12_38_24_8d4c7c12b5.png)
...
![create-service-port.png](https://assets.northflank.com/Screenshot_2025_12_01_at_12_42_00_f619f86192.png)

Click `Create service` to deploy you app. 
