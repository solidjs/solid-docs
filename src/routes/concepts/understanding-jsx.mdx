...
- **Data transfer**:
  Props are also used to fill components with data that comes from async computations, like [`createMemo`](/reference/basic-reactivity/create-memo) calls that return Promises.
