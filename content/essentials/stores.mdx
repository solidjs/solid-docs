...
Similar to [signals](/essentials/signals), Stores in Solid are a way to store state. 
Where signals hold a single piece of state, however, stores are capable of holding many. 
This means that
