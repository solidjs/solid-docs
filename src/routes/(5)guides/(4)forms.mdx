...
This guide builds that form in three passes.
...
Leave the fields that validate on submit uncontrolled, as in the three passes above.
:::
...
- [Data loading and mutations](/routing/solid-router/data): `.with()` for bound arguments, `.onSubmit` for optimistic updates, and revalidation after a mutation.
