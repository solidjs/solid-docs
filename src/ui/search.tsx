...
export function Search() {
	...
	const { active, setActive, onKeyDown } = createList({
		items: () => [
			...Array(Object.values(result()).flatMap((hits) => hits).length).keys(),
		],
		initialActive: 0,
		handleTab: false,
	});
			...
			<Dialog.Portal>
				...
				<Dialog.Content class="fixed inset-0 z-50 flex w-full flex-col overflow-hidden border border-black/5 bg-white pt-4 lg:bottom-auto lg:left-1/2 lg:top-14 lg:max-h-[calc(100%-56px-56px)] lg:max-w-[550px] lg:-translate-x-1/2 lg:rounded-2xl dark:border-white/60 dark:bg-slate-800">
					...
					<div class="flex items-center justify-center border-t border-black/10 px-4 pb-3 pt-2 text-sm lg:justify-between dark:border-slate-700">
						...
						<div>
							<A
								href="https://askorama.ai/?utm_source=docs.solidjs.com"
								target="_blank"
							...
							>
								...
								>
									<g clip-path="url(#a)">
										...
										<g clip-path="url(#b)">
											...
											<g mask="url(#e)">
												<path
													fill="url(#f)"
													d="m407.426 80.439-257.853 252.15 471.195 73.248 189.63-148.885v-99.868L407.426 80.439Z"
											...
											<path
												fill="url(#g)"
												fill-rule="evenodd"
												d="M273.468 135.438c27.943 31.249 25.263 79.234-5.985 107.177-142.84 127.734-155.079 347.036-27.342 489.891 27.942 31.249 25.262 79.234-5.986 107.177-31.248 27.943-79.231 25.263-107.173-5.986C-56.631 628.353-39.05 313.08 166.295 129.452c31.248-27.943 79.231-25.263 107.173 5.986Z"
												clip-rule="evenodd"
											/>
											<path
												fill="url(#h)"
												fill-rule="evenodd"
												d="M132.968 726.521c31.248-27.943 79.231-25.263 107.173 5.986C367.87 875.353 587.165 887.591 730.014 759.85c31.248-27.943 79.231-25.263 107.173 5.986 27.942 31.249 25.262 79.234-5.986 107.177-205.336 183.617-520.598 166.037-704.219-39.315-27.942-31.249-25.262-79.234 5.986-107.177Z"
												clip-rule="evenodd"
											/>
											<path
												fill="url(#i)"
												fill-rule="evenodd"
												d="M817.382 216.307c36.217-21.108 82.688-8.858 103.795 27.36 115.123 197.541 92.223 466.428-89.902 629.328-31.244 27.948-79.227 25.274-107.173-5.972-27.946-31.246-25.273-79.231 5.972-107.178 122.505-109.577 142.893-297.413 59.949-439.739-21.107-36.218-8.858-82.691 27.359-103.799Z"
												clip-rule="evenodd"
											/>
											<mask
												id="k"
											...
											>
												<path
													fill="url(#j)"
													fill-rule="evenodd"
													d="M817.382 216.307c36.217-21.108 82.688-8.859 103.795 27.36 115.123 197.54 92.223 466.427-89.902 629.328-31.244 27.947-79.227 25.273-107.173-5.973-27.946-31.245-25.273-79.23 5.972-107.177 122.505-109.578 142.893-297.414 59.949-439.74-21.107-36.218-8.858-82.69 27.359-103.798Z"
													clip-rule="evenodd"
												/>
											</mask>
											<g mask="url(#k)">
												<path
													fill="url(#l)"
													d="M787.171 527.842 533.284 792.631l372.153 105.907L1065 514.67 854.752 57.415l-18.773 381.987-48.808 88.44Z"
													style={{ "mix-blend-mode": "multiply" }}
												/>
											</g>
											<path
												fill="#F97CBF"
												fill-rule="evenodd"
												d="m832.644 128.021 22.19 24.558 22.255 24.558c-.55-.824-1.136-1.677-1.755-2.554l2.048 2.198c-.921-1.217-2.62-3.339-4.877-6.067-10.157-13.475-26.335-31.02-39.861-42.693Z"
												clip-rule="evenodd"
											/>
											<path
												fill="url(#m)"
												fill-rule="evenodd"
												d="M382.919 503.08c31.247-27.943 79.23-25.264 107.173 5.985 65.99 73.799 179.369 80.141 253.122 14.134 31.237-27.955 79.221-25.294 107.176 5.944 27.954 31.238 25.293 79.224-5.943 107.18-136.298 121.98-345.67 110.195-467.513-26.065-27.942-31.249-25.263-79.234 5.985-107.178Z"
												clip-rule="evenodd"
											/>
											<path
												fill="url(#n)"
												fill-rule="evenodd"
												d="M870.494 168.74c-27.954-31.238-75.938-33.899-107.175-5.944-27.05 24.208-32.671 63.437-15.539 93.804 9.421 10.174 18.178 21.885 25.669 34.2 48.241 72.967 36.944 172.257-30.207 232.308-31.248 27.943-33.927 75.928-5.985 107.177 27.943 31.249 75.926 33.929 107.173 5.985 136.256-121.847 148.04-331.227 26.064-467.53Z"
												clip-rule="evenodd"
											/>
											<path
												fill="url(#o)"
												fill-rule="evenodd"
												d="M741.442 250.089C634.37 124.866 409.641 115.57 267.487 242.69c-31.248 27.943-79.231 25.263-107.174-5.986-27.942-31.249-25.262-79.234 5.986-107.177C367.108-50.045 710.265-50.049 875.122 174.519c24.807 33.792 17.524 81.296-16.267 106.104-29.143 21.396-68.485 18.921-94.67-3.842-6.981-9.747-14.678-18.823-22.743-26.692Z"
												clip-rule="evenodd"
											/>
										</g>
									</g>
									<defs>
										...
										<clipPath id="a">
											<path fill="#fff" d="M0 0h4053v1000H0z" />
										</clipPath>
										<clipPath id="b">
											<path fill="#fff" d="M0 0h991.962v1000H0z" />
										</clipPath>
									</defs>
								</svg>
								<svg
									...
									<g clip-path="url(#a-dark)">
										...
										<g clip-path="url(#b-dark)">
											...
											<path
												fill="url(#g-dark)"
												fill-rule="evenodd"
												d="M273.468 135.438c27.943 31.249 25.263 79.234-5.985 107.177-142.84 127.733-155.079 347.036-27.342 489.891 27.942 31.249 25.262 79.234-5.986 107.177-31.248 27.943-79.231 25.263-107.173-5.986C-56.631 628.353-39.05 313.08 166.295 129.452c31.248-27.943 79.231-25.263 107.173 5.986Z"
												clip-rule="evenodd"
											/>
											<path
												fill="url(#h-dark)"
											...
											<path
												fill="url(#m-dark)"
												fill-rule="evenodd"
												d="M382.919 503.08c31.247-27.943 79.23-25.264 107.173 5.985 65.99 73.799 179.369 80.14 253.122 14.134 31.237-27.955 79.221-25.294 107.176 5.944 27.954 31.238 25.293 79.224-5.943 107.179-136.298 121.981-345.67 110.196-467.513-26.065-27.942-31.248-25.263-79.233 5.985-107.177Z"
												clip-rule="evenodd"
											/>
											<path
												fill="url(#n-dark)"
												fill-rule="evenodd"
												d="M870.494 168.74c-27.954-31.238-75.938-33.899-107.175-5.944-27.05 24.208-32.671 63.437-15.539 93.803 9.421 10.175 18.178 21.885 25.669 34.201 48.241 72.967 36.944 172.257-30.207 232.308-31.248 27.943-33.927 75.928-5.985 107.177 27.943 31.249 75.926 33.929 107.173 5.985 136.256-121.847 148.04-331.228 26.064-467.53Z"
												clip-rule="evenodd"
											/>
											<path
												fill="url(#o-dark)"
...
function trimText(text: string, term: string, wordPadding: number) {
	...
	const trimmedResult =
		wordsBeforeTerm.slice(startWordIndex).join(" ") + text.substring(termIndex);
