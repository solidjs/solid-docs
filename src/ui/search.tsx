	...
	return (
		<Dialog open={open()} onOpenChange={(open) => {
            ...
            .
											...
											<ul role="listbox">
												<For each={hits}>
													{(hit) => {
														...
														return (
															<li role="option" aria-selected={itemIndex === active() ? "true" : "false"}>
																<Dialog.CloseButton
																	as={A}
								...
								<div class="justify-center lg:justify-between items-center border-t border-black/10 dark:border-slate-700 pt-2 pb-3 text-sm flex">
