...
In this section we'll be taking a look into Typescript and how it is used to build Solid.js. This part might seem a little bit alien to Javascript developers unfamiliar with Typescript, so we will try our best to break it down as much as possible.
...
<Aside>
Inorder to configure a pre-existing Solid.js javascript project to make use of typescript follow this [guide](/guides/how-to-guides/get-ready-for-solid/installation-and-setup#setup-typescript-in-pre-existing-solidjs-javascript-projects).
</Aside>
