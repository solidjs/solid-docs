...
For typing standard or custom events using `on:` the TypeScript page has a section about [custom event handlers](/configuration/typescript#custom-event-handlers).
