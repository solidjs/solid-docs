...
## Setting Up a Linter 
Solid.js has a strong community of developers and some of those developers create tools that make the development experience that much better for other developers in the community. The eslint plugin we'll be making use of is just one of those tools made by one of our community members.
...
Now let's get down to adding the linter to our Solid.js project.
...
And that's it. Eslint should be setup and working with Solid.js code.
...
And that's it. Eslint should be setup for Typescript and Solid.js code.
