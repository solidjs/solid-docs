...
Components organize JSX into functions that receive props and return elements.
...
Props are passed as one object.
...
Use [`dynamic`](/reference/solid-js/components-context/dynamic) when a reactive source chooses the component or native element to render.
...
Use [`Dynamic`](/reference/solid-js/components-jsx/dynamic) when the selection belongs directly at one JSX call site.
