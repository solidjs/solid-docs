...
In addition, it has Solid's transitions included, so it can be used freely with [suspense](/solid-router/reference/components/suspense), [resources](/solid-router/reference/basic-reactivity/create-resource), and [lazy components](/reference/component-apis/lazy).
