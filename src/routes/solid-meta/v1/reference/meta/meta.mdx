...
```tsx
const Meta: Component<JSX.MetaHTMLAttributes<HTMLMetaElement> & { key?: string }>;
```
...
Wrap deliberate sets in [`<Head>`](/solid-meta/v1/reference/meta/head) so they coexist and override as a unit:
