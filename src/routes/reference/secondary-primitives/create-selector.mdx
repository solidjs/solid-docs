...
`createSelector` has been removed in Solid 2.0. It is replaced by [`createProjection`](/reference/store-utilities/create-projection) for mutable derived stores, or [`createStore(fn)`](/reference/store-utilities/create-store) for derived stores.
:::
