...
<Aside>
  For more information and further build and deployment instructions and features visit the <Link href="https://vercel.com/docs" target="_blank">Vercel documentation</Link>
</Aside>