...
When used in reactive contexts, such [`createEffect`](/solid-js/reference/basic-reactivity/create-effect), [`createMemo`](/solid-js/reference/basic-reactivity/create-memo) or a [`createRoot`](/solid-js/reference/reactive-utilities/create-root), it runs when the reactive scope is diposed or refreshed.
