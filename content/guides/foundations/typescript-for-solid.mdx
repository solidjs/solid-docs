...
<Aside>
To configure a pre-existing Solid.js Javascript project to use Typescript, follow this [guide](/guides/how-to-guides/get-ready-for-solid/installation-and-setup#setup-typescript-in-pre-existing-solidjs-javascript-projects).
</Aside>
