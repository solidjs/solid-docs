...
[Props](/solid-js/concepts/components/props) are another way to change styles.
...
For a guide on how to style your components, see [Styling Your Components](/solid-js/guides/styling-your-components), where we cover the different ways to style your components using libraries such as [TailwindCSS](https://tailwindcss.com/).
