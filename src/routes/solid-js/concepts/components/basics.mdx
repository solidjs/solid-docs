...
Components are functions that return [JSX](/solid-js/concepts/understanding-jsx) elements:
...
A Solid component's lifecycle is different from other frameworks, as it is tied to the [concept of reactivity](/solid-js/concepts/intro-to-reactivity).
...
This includes setting up [signals](/solid-js/concepts/signals), [stores](/solid-js/concepts/stores), [effects](/solid-js/concepts/effects), and other reactive elements.
...
<Callout>
To simplify conditional rendering, Solid provides built-in [control-flow](/solid-js/concepts/control-flow/conditional-rendering) components like [`Show`](/solid-js/concepts/control-flow/conditional-rendering#show), which create a more readable conditional rendering experience.
