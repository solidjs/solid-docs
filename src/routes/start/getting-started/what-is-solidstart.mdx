...
<Aside title="Rough waters ahead" type="warning">
    We are very excited about SolidStart, but it is in alpha. There **will be bugs**. There very likely be **missing documentation**. Come at it with a growth attitude, have fun, and don't use it yet for anything critical.
    
    If all this darkness doesn't phase you, press onward, and consider joining the [discord](https://discord.com/invite/solidjs) to ask questions. We would love to meet you.
</Aside>
