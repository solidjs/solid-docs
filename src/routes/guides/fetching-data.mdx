...
In Solid 2.0, async is a first-class capability of computations — you can use `createMemo` or derived stores to fetch data, and the reactive system handles loading, error, and refresh states automatically.
...
To handle errors during data fetching, wrap async reads in an [`Errored`](/concepts/control-flow/error-boundary) boundary:
