...
[Async reactivity](/concepts/async-reactivity) explains the mechanism; [Style active and pending links](/routing/solid-router/navigation#style-active-and-pending-links) shows how to indicate the pending state.
