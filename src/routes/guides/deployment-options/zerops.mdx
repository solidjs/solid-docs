...
**Note**: If you're in compact mode, you won't see a sidebar but use the top navigation bar. If you're in full mode, you'll see a sidebar, making it easier for you to navigate.
...
Zerops YAML should be added to the root of the project. It tells Zerops how to build and run the app.
