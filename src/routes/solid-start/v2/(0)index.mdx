...
SolidStart v2 builds a full-stack app on top of [Solid v1](/), [Solid Router v1](/solid-router), and [Vite v8+](https://vite.dev). It uses Vite's Environment API for client and server builds and works with deployment Vite plugins such as [Nitro v3](https://nitro.build) and the [Cloudflare Vite plugin](https://www.npmjs.com/package/@cloudflare/vite-plugin).
