...
Callback refs provide a more flexible way to set refs and can be beneficial in various scenarios, such as when you need to attach event listeners to the DOM elements immediately after creation.
