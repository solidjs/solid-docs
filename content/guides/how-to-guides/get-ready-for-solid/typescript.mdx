...
In this section we'll be taking a look into Typescript and how it is used in Solid.js. This part might seem a little bit alien to Javascript developers unfamiliar with Typescript, so we will try our best to break it down as much as possible.
