...
For cases like this, you can use [Memos](/concepts/derived-values/memos) to store the value of `doubleCount`, which is also referred to as a memoized or cached value. 
