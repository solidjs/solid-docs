...
The stores API are available at **solid-js/stores**. They allow the creation of stores: [proxy objects](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Proxy) that allow a tree of signals to be independently tracked and modified.
...
<Callout>
  To delete all properties of an object, you can use [reconcile](/reference/store-utilities#reconcile) like so:
  ```ts
