...
In this example, a [`query`](/solid-router/concepts/queries) is created.
The [`createAsync` primitive](/solid-router/reference/data-apis/create-async) is used to access its data.
