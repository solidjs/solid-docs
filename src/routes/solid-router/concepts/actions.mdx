...
Actions represent the server-side component of an [HTML form](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/form).
...
In this example, the `echo` action simualtes a fetch call with a 1 second delay before logging the message to the console.
