...
## 1. Solid uses declarative programming

Declarative programming refers to the practice of writing computer code that explains what your program does rather than how it accomplishes it. Imperative programming operates in the opposite manner. Let's take a brief look at each of these.
