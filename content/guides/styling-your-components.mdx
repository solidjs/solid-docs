...
Within the [Solid ecosystem](/ecosystem), there have been various libraries and solutions available for working with CSS-in-JS, including but not limited to:
...
1. Install and setup the Macaron plugin for your bundler:
...
```jsx
mport { styled } from '@macaron-css/solid';
