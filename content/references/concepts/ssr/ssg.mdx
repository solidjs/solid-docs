...
In this section we will be talking about static site generation and how you can implement it in Solid.js.
...
In the above code we're taking in our Solid.js component and rendering it into a string using the `renderToStringAsync` function.
