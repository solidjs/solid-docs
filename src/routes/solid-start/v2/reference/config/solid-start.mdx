...
Starting with `@solidjs/start@2.0.0-rc.8`, the handler may be async. SolidStart awaits it before serializing the error, allowing monitoring services to flush first.
