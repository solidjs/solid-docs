...
export function NavPreferences() {
  return (
    <details class="border border-solid-lightitem dark:bg-solid-dark dark:border-solid-darkitem rounded-lg">
      <summary class="flex items-center justify-between p-4 w-full cursor-pointer">
