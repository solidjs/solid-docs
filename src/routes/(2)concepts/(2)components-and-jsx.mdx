...
:::note
If you are coming from React, you might be used to using onChange instead of onInput.
In Solid, the event name is the same as the DOM event name.
:::
...
:::note
`onSettled` replaces `onMount` from Solid v1. Read the [onSettled](/reference/solid-js/lifecycle-actions/on-settled) reference for more information.
:::
...
If you are coming from Solid 1, you might be used to a `ThemeContext.Provider` component.
