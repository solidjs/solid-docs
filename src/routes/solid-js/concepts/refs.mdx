...
This can be done by using [`onMount`](/solid-js/reference/lifecycle/on-mount) to wait until the element is attached to the DOM before accessing it:
...
To use [`ref`](/solid-js/reference/jsx-attributes/ref), you declare a variable and use it as the `ref` attribute:
...
[Signals](/solid-js/concepts/signals) can also be used as refs.
...
The [`use:`](/solid-js/reference/jsx-attributes/use) prefix is used to denote these custom directives.
...
- creating [signals](/solid-js/concepts/signals)
- initiating [effects](/solid-js/guides/state-management#reacting-to-changes)
- adding [event listeners](/solid-js/concepts/components/event-handlers)
- and more.

To learn more about directives and how they work with TypeScript, refer to our [TypeScript for Solid guide](/solid-js/configuration/typescript).
