...
Solid Meta 1.x is a thin component layer over Solid 2.0's built-in head registry ([`useHead`](/solid-meta/v1/reference/meta/use-head) in `@solidjs/web`). There is **no provider** — the registry is ambient. Render a head component anywhere and it registers under the current reactive owner, and server rendering splices the winning tags into your document automatically.
