...
For more fine-grained control, you can trigger revalidation manually with the [`revalidate`](/solid-router/reference/data-apis/revalidate) function.
...
To control this behavior, you can use suspense boundaries - regions of the component tree defined by a [`<Suspense>`](/reference/components/suspense) component.
