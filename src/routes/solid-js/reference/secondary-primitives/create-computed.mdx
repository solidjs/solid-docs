...
Before using it, consider the closely related primitives [`createMemo`](/solid-js/reference/basic-reactivity/create-memo) and [`createRenderEffect`](/solid-js/reference/secondary-primitives/create-render-effect).

Like `createMemo`, `createComputed` calls its function immediately on updates (unless you're in a [batch](/solid-js/reference/reactive-utilities/batch), [effect](/solid-js/reference/basic-reactivity/create-effect), or [transition](/solid-js/reference/reactive-utilities/use-transition)). 
