...
The return value is a [memo](/solid-js/reference/basic-reactivity/create-memo) evaluating to the resolved children, which updates whenever the children change. 
...
This can be undesirable for conditional rendering, e.g., when using the children within a [`<Show>`](/solid-js/reference/components/show) component. 
