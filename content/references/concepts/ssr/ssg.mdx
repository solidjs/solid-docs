...
<Aside type="general"> This process of implementing SSG in Solid is more complicated when compared to implementing other forms of SSR in Solid.js, so please follow along carefully </Aside>
