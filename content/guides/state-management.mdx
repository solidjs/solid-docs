...
<Aside>
  ...
  While props are primarily read-only, there are [specific utlity functions for props](/concepts/components/props) that offer methods to interact with props beyond their inherent read-only nature.
...
This is where [stores](/concepts/stores) come in, offering options tailored to meet the demands of more complex applications.
