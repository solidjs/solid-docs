...
Additionally, Solid's [reactive](/solid-js/concepts/intro-to-reactivity) system introduces [fine-grained reactivity](/solid-js/advanced-concepts/fine-grained-reactivity) with JSX.
...
- **Data transfer**:
  Props are also used to fill components with data that comes from resources, like [`createResource`](/solid-js/reference/basic-reactivity/create-resource) calls.
...
For how to use props effectively in Solid, explore the [props page](/solid-js/concepts/components/props).
