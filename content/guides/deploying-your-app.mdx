...
<div id="yarn">```bash yarn global add wrangler ```</div>
...
<div id="yarn">```bash yarn global add netlify-cli ```</div>
...
<div id="yarn">```bash yarn global add @railway/cli ```</div>
...
<div id="yarn">```bash yarn global add vercel ```</div>
