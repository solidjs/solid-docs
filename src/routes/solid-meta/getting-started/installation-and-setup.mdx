...
<Callout title="Prerequisites">
	If using Solid `v1.0`, use version `0.27.x` or greater. For earlier versions
	(eg. `v0.x`), you must use `v0.26.x`.
</Callout>
...
<div id="yarn">```bash frame="none" yarn add @solidjs/meta ```</div>
