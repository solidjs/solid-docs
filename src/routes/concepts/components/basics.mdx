...
This includes setting up [signals](/concepts/signals), [stores](/concepts/understanding-stores), [effects](/concepts/understanding-effects), and other reactive elements.
