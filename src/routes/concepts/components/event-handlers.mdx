...
<Callout type="tip" title="Dynamic Handlers">
...
Event delegation is designed for event propagation through the JSX Tree,
...
Here is a [Solid Playground Example](https://playground.solidjs.com/anonymous/c5346f84-01e4-4080-8ace-4443ffd0bb10)
...
Here is a [Solid Playground Example](https://playground.solidjs.com/anonymous/9e2deddc-2e83-4ac2-8ee0-49c7c3a45d11)
...
<Callout type="tip" title="onInput / onChange">

Note that `onChange` and `onInput` work according to their native behavior.
`onInput` will fire immediately after the value has changed; for `<input>`
