...
<div id="npm">
```bash frame="none"
npm install @macaron-css/core @macaron-css/solid @macaron-css/vite
```
</div>

<div id="yarn">
```bash frame="none"
yarn add @macaron-css/core @macaron-css/solid @macaron-css/vite
```
</div>

<div id="pnpm">
```bash frame="none"
pnpm i @macaron-css/core @macaron-css/solid @macaron-css/vite
```
</div>
</TabsCodeBlocks>
