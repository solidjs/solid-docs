...
When a signal is called within a [tracking scope](/concepts/intro-to-reactivity#tracking), it forms a dependent between the signal and the wrapping function. 
...
[Effects](/concepts/effects) and [memos](/concepts/memos) subscribe to signals, thereby establishing a *dependency* on them.
