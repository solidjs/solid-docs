...
### 3. Let the plugin generate entries
...
### 4. Split `App.tsx` and `Document.tsx`
...
### 6. Move route modules incrementally
...
### 8. Rebuild environment handling
...
### 9. Rewrite sessions and authentication
...
### 10. Rewrite middleware and API routes
...
### 11. Rebuild the deployment boundary
...
### 12. Resolve removed framework features
