...
<Aside type="advanced">
**Note**: When working with JSX, the system translates parts of your code into structured HTML that is placed at the start of the file.
...
For how to use props effectively in Solid, explore the [components and props](/essentials/components-and-props) page.
