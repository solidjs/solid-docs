...
export default function Root() {
  ...
  return (
    <Html lang="en" class={"h-full " + config.mode}>
      ...
      <Body class="px-4 pb-8 font-sans antialiased text-lg bg-white dark:bg-solid-darkbg text-black dark:text-white leading-base min-h-screen lg:flex lg:flex-row">
        <Suspense>
