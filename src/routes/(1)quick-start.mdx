...
- Learn how Solid renders and updates [components](/concepts/components/basics).
- Understand Solid's reactive system in [Intro to reactivity](/concepts/intro-to-reactivity).
- Explore reactive state in more detail with [Signals](/concepts/signals).
