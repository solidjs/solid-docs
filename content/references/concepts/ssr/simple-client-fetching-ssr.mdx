...
<Aside type="general">
  Keep in mind that you will need a bundler like Vite, Webpack, or Rollup to bundle your application. Here's a fully functional example using rollup and express. <a href="https://github.com/ryansolid/solid-ssr-workbench">solid-ssr-workbench</a>. This repo contains examples on how to use Solid.js with all 3 forms of SSR.
</Aside>
