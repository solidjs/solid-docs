...
[SolidStart 1](https://v1.docs.solidjs.com/solid-start) uses Vinxi, Nitro, `app.config.ts`, and framework-owned entries.
...
[Released SolidStart 2](https://v1.docs.solidjs.com/solid-start/v2) uses Solid 1, `solidStart()`, Vite environment builds, and a deployment plugin such as Nitro.
...
The current source baselines are [`vite-plugin-solid` at `519da14d`](https://github.com/solidjs/vite-plugin-solid/tree/519da14d20a51dd0a856eb9acfdae784a567bf10) and the [`solid-v2` templates at `cbbd8ba2`](https://github.com/solidjs/templates/tree/cbbd8ba26ed7f909455abe142de74e204b039974/solid-v2).
