...
<h1> {console.log("temo 1")} hello </h1>
...
<h1> {console.log("temo 2")} hello </h1>
...
<h1> {console.log("temo 3")} hello </h1>
...
<h1> {console.log("temo 4")} hello </h1>
...
<h1> {console.log("goodbye")} hello </h1>
