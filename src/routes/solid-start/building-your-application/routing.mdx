...
SolidStart traverses your `routes` directory, collects all the routerSchema, and then makes them accessible using the [`<FileRoutes />`](/solid-start/reference/routing/file-routes).
