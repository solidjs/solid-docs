...
<TabsCodeBlocks>
	<div id="npm">```bash frame="none" npm i -g @zerops/zcli ```</div>
	<div id="pnpm">```bash frame="none" pnpm add -g @zerops/zcli ```</div>
	<div id="yarn">```bash frame="none" yarn global add @zerops/zcli ```</div>
</TabsCodeBlocks>
