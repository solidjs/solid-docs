...
Solid Router supports config-based routing, offering the same capabilities as [component routing](/solid-router/getting-started/component).
The choice of config-based routing over component routing is largely a matter of personal preference.
