...
`createResource` integrates with [`Suspense`](/solid-js/reference/api/suspense) and [`ErrorBoundary`](/solid-js/reference/api/error-boundary) to help manage lifecycle and error states.
...
If the data needs a refresh, the [`refetch`](/solid-js/guides/fetching-data#refetch) function returned in the `createResource` can be used.
